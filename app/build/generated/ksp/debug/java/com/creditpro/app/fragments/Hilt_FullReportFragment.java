...
public abstract class Hilt_FullReportFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FullReportFragment() {
    super();
  }

  Hilt_FullReportFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FullReportFragment_GeneratedInjector) this.generatedComponent()).injectFullReportFragment(UnsafeCasts.<FullReportFragment>unsafeCast(this));
    }
  }
