...
public abstract class Hilt_MapViewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MapViewFragment() {
    super();
  }

  Hilt_MapViewFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapViewFragment_GeneratedInjector) this.generatedComponent()).injectMapViewFragment(UnsafeCasts.<MapViewFragment>unsafeCast(this));
    }
  }
