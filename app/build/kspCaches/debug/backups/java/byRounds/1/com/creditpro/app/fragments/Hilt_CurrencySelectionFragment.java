...
public abstract class Hilt_CurrencySelectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CurrencySelectionFragment() {
    super();
  }

  Hilt_CurrencySelectionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CurrencySelectionFragment_GeneratedInjector) this.generatedComponent()).injectCurrencySelectionFragment(UnsafeCasts.<CurrencySelectionFragment>unsafeCast(this));
    }
  }
