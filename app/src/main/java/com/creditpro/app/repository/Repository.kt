...
import com.creditpro.app.services.NotificationReceiver
...
class CreditProRepository @Inject constructor(
    ...
    suspend fun saveUser(user: com.creditpro.app.models.User) = userDao.insertUser(user)
    suspend fun updateUser(user: com.creditpro.app.models.User) = userDao.updateUser(user)
    suspend fun deleteUser() = userDao.deleteAll()

    // Credit Score
    fun getLatestScore() = creditScoreDao.getLatestScore()
    suspend fun saveScore(score: com.creditpro.app.models.CreditScore) = creditScoreDao.insertScore(score)
