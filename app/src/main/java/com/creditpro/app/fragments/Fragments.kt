...
import com.creditpro.app.activities.OnboardingActivity
import com.creditpro.app.adapters.*
import com.creditpro.app.databinding.*
import com.creditpro.app.models.*
import com.creditpro.app.services.DataService
import com.creditpro.app.services.TranslationManager
import com.creditpro.app.viewmodels.*
...
class LanguageSelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvLanguage.adapter = com.creditpro.app.adapters.SelectionAdapter(languages, currentLang) { lang ->
...
class CurrencySelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvCurrency.adapter = com.creditpro.app.adapters.SelectionAdapter(currencies, currentCur) { cur ->
